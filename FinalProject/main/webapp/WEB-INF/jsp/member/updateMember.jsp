	...
	<div class="container">
		<form name="newMember" class="form-horizontal"
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="id" type="text" class="form-control" placeholder="id" readOnly value="<c:out value='${member.ID}'/>" >
				</div>
			</div>
			<div class="form-group  row">
				<label class="col-sm-2">비밀번호</label>
				<div class="col-sm-3">
					<input name="pw" type="text" class="form-control" placeholder="pw" value="<c:out value='${member.PW}'/>" >
				</div>
			</div>
			<div class="form-group  row">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="nickname" type="text" class="form-control" placeholder="nickname" value="<c:out value='${member.NICKNAME}'/>" >
				</div>
			</div>
			<div class="form-group  row">
				<label class="col-sm-2">영어 이름</label>
				<div class="col-sm-3">
					<input name="name" type="text" class="form-control" placeholder="english name" value="<c:out value='${member.NAME}'/>" >
				</div>
			</div>
			<div class="form-group  row ">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="hello" type="text" class="form-control" placeholder="phone" value="<c:out value='${member.HELLO}'/>">
				</div>
			</div>
			<div class="form-group  row">
